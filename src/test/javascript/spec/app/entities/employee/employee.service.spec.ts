...
import { IEmployee, Employee, Grade, JobTitle } from 'app/shared/model/employee.model';
...
describe('Service Tests', () => {
  describe('Employee Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Employee(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, Grade.I2, JobTitle.POSTMAN);
    });
