...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
public class OrderItemResource {
    ...
    public ResponseEntity<List<OrderItemDTO>> getAllOrderItems(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
