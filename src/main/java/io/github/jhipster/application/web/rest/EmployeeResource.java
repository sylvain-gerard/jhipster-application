...
public class EmployeeResource {
    ...
    public ResponseEntity<List<EmployeeDTO>> getAllEmployees(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
