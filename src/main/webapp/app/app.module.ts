...
import { JhipsterApplicationCoreModule } from 'app/core';
...
import { JhipsterApplicationAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    ...
    JhipsterApplicationSharedModule.forRoot(),
    JhipsterApplicationCoreModule,
    JhipsterApplicationHomeModule,
    JhipsterApplicationAccountModule,
